...
async def cmd_start(update: Update, ctx: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if state == UserState.NEW:
        ...
        _PINNED_INTRO = (
            "📌 *Шпаргалка — сохрани*\n\n"
            "Я Мира — твой ежедневный AI помощник по контенту.\n\n"
            "━━━━━━━━━━━━━━━━\n"
            "*Что создаём:*\n"
            "✍️ *Посты* — в твоём голосе, с хуком и CTA\n"
            "🎬 *Рилсы* — 14 хуков под тему + описание\n"
            "🎠 *Карусели* — заголовок + структура всех слайдов\n"
            "🔥 *Прогревы* — серия из 3 дней которая ведёт к покупке\n"
            "📸 *Сторис* — цепочка которую досматривают до конца\n"
            "🎙 *Talking Head* — сценарий монолога в кадре\n\n"
            "━━━━━━━━━━━━━━━━\n"
            "*Анализ и стратегия:*\n"
            "🩺 *Диагностика* — покажет что конкретно буксует в контенте\n"
            "🔍 *Разбор профиля* — честный взгляд на аккаунт\n"
            "🔎 *Разбор конкурента* — что у них работает и почему\n"
            "📅 *Контент-план TG* — на 7-14 дней с темами и хуками\n"
            "💬 *Чат с Мирой* — стратегия, идеи, любой вопрос про контент\n\n"
            "━━━━━━━━━━━━━━━━\n"
            "*Как я становлюсь точнее со временем:*\n"
            "🎙 Говори голосом — понимаю живую речь\n"
            "✅ После каждого текста жми «Звучит как я» — запоминаю твой стиль\n"
            "📝 Скинь 2-3 своих поста в Мой стиль — начну писать твоими словами\n\n"
