...
register(AgentSpec(
    ...
    welcome      = (
        ...
        "🎙 *Запиши голосовое* — расскажи тему или идею как другу.\n"
        "Или напиши текстом — оба варианта работают одинаково хорошо.\n"
        "_Можешь поделиться черновиком, тезисом или просто мыслью_"
    ),
